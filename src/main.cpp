...
const i32 pst_rank[][8] = {
    ...
    {S(-3, -5), S(-1, -3), S(0, -1), S(2, 3), S(4, 3), S(6, 1), S(4, 0), S(-12, 1)},
    {S(-1, -2), S(1, -1), S(1, 0), S(1, 0), S(2, 1), S(3, 0), 0, S(-9, 2)},
    {S(-1, -3), S(-2, -3), S(-3, -2), S(-3, 1), S(-1, 2), S(2, 2), S(3, 3), S(5, 1)},
    {S(1, -12), S(2, -9), S(0, -5), S(-1, 1), S(-1, 6), S(1, 5), S(-2, 8), S(1, 6)},
    {S(0, -6), S(0, -2), S(-2, 0), S(-4, 3), S(-1, 4), S(5, 4), S(3, 2), S(4, -4)},
};
const i32 pst_file[][8] = {
    {S(-1, 1), S(-2, 1), S(-1, 0), S(0, -1), S(1, 0), S(2, 0), S(2, 0), S(-1, -1)},
    {S(-5, -3), S(-2, -1), S(0, 1), S(2, 3), S(2, 2), S(2, 0), S(1, 0), S(-1, -3)},
    {S(-2, 0), 0, S(1, 0), S(0, 1), S(1, 1), S(-1, 1), S(2, 0), S(0, -1)},
    {S(-2, 0), S(-2, 1), S(-1, 1), S(1, 0), S(1, -1), S(1, 0), S(2, 0), S(-1, -1)},
    {S(-3, -5), S(-2, -3), S(-1, 0), S(0, 1), S(0, 2), S(1, 3), S(2, 2), S(3, -1)},
    {S(-2, -5), S(2, -2), S(-2, 1), S(-3, 2), S(-4, 2), S(-1, 1), S(2, -1), S(0, -5)},
};
const i32 open_files[][5] = {
    {S(1, 4), S(-5, 20), S(19, 15), S(2, 17), S(-24, 10)},
    {S(-3, -13), S(-11, -1), S(48, 0), S(-14, 34), S(-63, 2)},
};
