...
const i32 pst_rank[] = {
    0,         S(-2, 0), S(-3, -1), S(-1, -1), S(1, 0),   S(5, 2),   0,         0,        S(-4, -5), S(-2, -3),
    S(-1, -1), S(1, 3),  S(3, 4),   S(7, 1),   S(5, 0),   S(-11, 1), S(-2, -2), S(1, -2), S(1, 0),   S(1, 0),
    S(2, 1),   S(4, 0),  S(1, 0),   S(-8, 2),  S(-2, -4), S(-2, -4), S(-3, -2), S(-4, 1), S(-1, 2),  S(3, 2),
    S(3, 3),   S(6, 1),  S(1, -13), S(1, -10), S(0, -5),  S(-1, 1),  S(-1, 6),  S(1, 5),  S(-2, 9),  S(1, 7),
    S(0, -6),  S(0, -2), S(-2, 0),  S(-4, 3),  S(-1, 4),  S(5, 4),   S(3, 3),   S(4, -4),
};
const i32 pst_file[] = {
    S(-2, 1),  S(-1, 1),  S(-1, 0),  S(0, -1),  S(1, 0),  S(2, 0),   S(2, 0),  S(-1, -1), S(-4, -3), S(-2, -1),
    S(0, 1),   S(2, 3),   S(2, 2),   S(2, 0),   S(1, -1), S(-1, -3), S(-2, 0), 0,         S(1, 0),   S(0, 1),
    S(0, 1),   S(-1, 1),  S(2, -1),  S(0, -1),  S(-2, 0), S(-2, 1),  S(-1, 1), S(1, 0),   S(1, -1),  S(1, 0),
    S(2, 0),   S(-1, -1), S(-3, -4), S(-2, -2), S(-1, 0), S(0, 1),   S(0, 2),  S(1, 3),   S(2, 1),   S(3, -1),
